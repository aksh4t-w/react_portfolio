export const projects = [
    {
        ...
        description: 'Amazon web clone made using React with Firebase as backend for authentication and data storage.'
    },
    {
        title: 'Netflix Clone',
        img_path : '/images/netflix.png',
        url: 'https://netflix-clone-b5d54.web.app/',
        description: 'A Netflix clone built using React. TMDb API is used for fetching Movie/TV details.'
    },
    {   
